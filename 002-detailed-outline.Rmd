...
- [Lesson 1](#ch_invitation) An Invitation to Data Visualization (Chapter \@ref(ch_invitation), Video for Lesson 1, [Slides](slides/lesson-01.html))
- Task 1. [Instructions](#task_1). Submit on Brightspace. Due by the end of the day on Monday 11 January.
- First synchronous meeting Thursday 7 January, 8:35 Atlantic on Collaborate (Brightspace)
- [Lesson 2](#ch_tools) The tools we will use and why: R, Rstudio, ggplot, tidyverse, markdown, git, github. (Chapter \@ref(ch_tools), Video for Lesson 2, [Slides](slides/lesson-02.html))
- Lesson 3 Computer preliminaries. Installing R, Rstudio, packages, creating github account
- Task 2. [Instructions](#task_2). Submit on Brightspace. Due by the end of the day on Monday 11 January.

### Week 2: Jan 11-15

- [Lesson 4](#look-data) Look at data. 
- [Lesson 5](#first-plot) Making your first plot. 
