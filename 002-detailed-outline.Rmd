...
- Lesson 2 Course Overview - objectives and sample skills (computing, data)
- Lesson 3 Computer preliminaries. Installing R, Rstudio, packages, creating github account

### Week 2: Jan 11-15

- Lesson 3 Look at data. [Healy Chapter 1](https://socviz.co/lookatdata.html#lookatdata)
- Lesson 4 The tools we will use and why: R, Rstudio, ggplot, dplyr, markdown, git, github
