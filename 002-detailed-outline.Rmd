...
- Lesson 1: An Invitation to Data Visualization. [Notes](#ch-invitation), Video, [Slides](slides/lesson-01.html).
- Synchronous meeting Thursday 7 January, 8:35 Atlantic on Collaborate (Brightspace)
- Lesson 2: The tools we will use and why: R, Rstudio, ggplot, tidyverse, markdown, git, github. [Notes](#ch-tools), Video, [Slides](slides/lesson-02.html)
