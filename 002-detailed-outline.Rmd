...
- Office hours. Tuesday 12 January, 8:35 Atlantic on Collaborate. 
...
- Office hours. Tuesday 19 January, 8:35 Atlantic on Collaborate.
...
Tasks 5 and 6 are due Monday 25 January at 9:00 am Atlantic time. Complete both tasks as part of the same repository. Click [here](no link yet) to get the repository for tasks-5+6.
...
Click the following links to get two repostories: [tasks-7+8](no link yet) and [assignment-2](no link yet).
...
Click [here](no link yet) to add the repostory for tasks-9+10.
