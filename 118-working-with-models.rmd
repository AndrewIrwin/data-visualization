...
Let's make five factets, one for each country, and add a smooth to each panel.
...
This is not an idea facetted plot -- there are probably too many facets (countries) and the text labels don't fit well in the space. You might draw a plot like this for yourself to explore the data and plan an analysis or other plot.
