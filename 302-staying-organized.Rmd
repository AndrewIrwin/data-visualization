...
Create a new directory called something meaningful like "R projects" or "Data visualization" wherever you keep your other files. (I put mine in 'Dropbox' so I don't have to worry about backups.) Then whenever you start a new project (assignment, lesson, etc.) start a new project in a new sub-folder (see below.)
