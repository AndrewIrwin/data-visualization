# Synchronous meeting agendas {#sync .unnumbered}
...
## Thu 18 March 8:35 {#sync-10 .unnumbered}
...
* Making maps and alterantives to maps

Here are links to materials for the synchronous session. Download the Rmd file before class by right (or control) clicking the Rmd link.  

  * Materials for use during class: [HTML](https://htmlpreview.github.io/?https://github.com/AndrewIrwin/data-visualization/blob/master/live-coding/live-coding-10.html) and [Rmd](https://raw.githubusercontent.com/AndrewIrwin/data-visualization/master/live-coding/live-coding-10.rmd) 
  * Work done in class: [HTML](https://htmlpreview.github.io/?https://github.com/AndrewIrwin/data-visualization/blob/master/live-coding/live-coding-10-after-class.html) and [Rmd](https://raw.githubusercontent.com/AndrewIrwin/data-visualization/master/live-coding/live-coding-10-after-class.rmd)

## Thu 25 March 8:35 {#sync-11 .unnumbered}
...
Here are links to materials for the synchronous session. Download the Rmd file before class by right (or control) clicking the Rmd link. 
  ...
  * Materials for use during class: [HTML](https://htmlpreview.github.io/?https://github.com/AndrewIrwin/data-visualization/blob/master/live-coding/live-coding-11.html) and [Rmd](https://raw.githubusercontent.com/AndrewIrwin/data-visualization/master/live-coding/live-coding-11.rmd) 
  * Work done in class: [HTML](https://htmlpreview.github.io/?https://github.com/AndrewIrwin/data-visualization/blob/master/live-coding/live-coding-11-after-class.html) and [Rmd](https://raw.githubusercontent.com/AndrewIrwin/data-visualization/master/live-coding/live-coding-11-after-class.rmd)
  
  
## Thu 1 April 8:35 {#sync-12 .unnumbered}

Oral presentations day 1. Each presentation will be a maximum of 5 minutes, plus time for questions, changing to the next group, etc.

Presentations may be made live or can be pre-recorded.

The presentation schedule is in the GitHub [repository](https://github.com/Dalhousie-AndrewIrwin-Teaching/team-planning) in the [presentation schedule](https://github.com/Dalhousie-AndrewIrwin-Teaching/team-planning/blob/main/presentation-schedule.csv) file.

Each person is expected to provide feedback for one presentation today. For instructions see the repository for Assignment 6. The [peer evaluation schedule](https://github.com/Dalhousie-AndrewIrwin-Teaching/team-planning/blob/main/peer-evaluation-schedule.csv) is in the team planning repository.
...
Oral presentations day 2. Each presentation will be a maximum of 5 minutes, plus time for questions, changing to the next group, etc.
