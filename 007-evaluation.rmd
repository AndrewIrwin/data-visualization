...
### Task 9 (Lesson 15) {#task-9 .unnumbered}

Work with models

### Task 10 (Lesson 16) {#task-10 .unnumbered}

Linear models

### Bonus task (Lesson 17) {#task-b7 .unnumbered}
...
### Task 12 (Lesson 19) {#task-12 .unnumbered}

MDS

### Bonus task (Lesson 20) {#task-b8 .unnumbered}
...
Collaboration and reproducible reports

### Task 14 (Lesson 22) {#task-14 .unnumbered}

Slide presentations

### Task 15 (Lesson 21) {#task-15 .unnumbered}
...
_Incomplete, being created._

learn, describe, and use a table layout package (not kable/kableExtra)
- DT, gt, flextable,
...
Teams will be created between February 1-21. On February 1 (or earlier) I will add everyone to a reposistory called `project-planning`. This repository will be used to create teams, schedule presentations, and organize peer-evaluation for Assignment 6.

If you would like to form a team with someone else in the class, edit the rmd document to add your request. If you would like to be assigned a randomly selected team mate, there will be a way to indicate that too. This process will also introduce you to some collaboration features of github. The deadline for selecting teammates will be Monday 22 February. I will review this list and finalize the assignments in time for Monday 1 March (or earlier). I will create the presentation schedule and peer-evaluation assignments at the same time.
