...
Most evaluations in our course will require you to use git and github. Depending on how you work on your final project, you may use it as a tool for collaboration.
...
* Checking to be sure git is working on your computer
* Creating a new Rstudio project and enabling version control
* Adding a file to your project
* Staging changes to your files to be committed to your local git repository
* Committing your staged changes to your local git repository
